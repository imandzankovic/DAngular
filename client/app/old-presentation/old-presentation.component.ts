...
@Component({
  selector: 'app-presentation-old',
  templateUrl: './old-presentation.component.html',
  styleUrls: ['./old-presentation.component.css']
})

export class OldPresentationComponent implements OnInit {
