...
export class SlideDetailComponent implements OnInit {
  ...
  processKanva(canva, slideSection, slidesPanel) {
    ...
    chartDiv.style.cssText = `height: 300px; width:440px;`
    chartDiv.innerHTML = "<div id='chartContainer1'  style='height: 300px; width:440px;'></div>";
  ...
  appendSlides(data, id, answers, panelId) {
    ...
    slideSection.style.cssText = `height: 300px; width:440px; background-color: white;`;
    ...
    $.each(data, function (index, element) {
      ...
      if (element.type == 'h2') {
        ...
        answers.forEach(item => {
          ...
          frame.style.cssText = 'border: 2px solid grey; border-radius: 5px; height:40px; width:200px;'
          var h2 = document.createElement("h2");
          h2.innerHTML = item;
          h2.style.cssText = 'font-size:15px; color:black; margin-left:10px; margin-top:5px';
